...
contract Divinex is SafeMath {
    string public constant name     		            = "Divinex";                     // Name of the token
    string public constant symbol   		            = "DVX";                           // Symbol of token
    ...
    address public admin                                = 0xca8c5471545924a483d2246c5d5fb6d4417d6d1e;// Admin of smart contract 
